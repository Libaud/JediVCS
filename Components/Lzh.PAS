 ...
 *                                                Danny.Heijl@cevi.be
 * Updated to Delphi 4. March 26, 1999. François PIETTE
 *    Rue de Grady 24, 4053 Embourg, Belgium
 *    francois.piette@overbyte.be
 *    http://www.overbyte.be
 * Updated for LongWORD by Paolo Lanzoni <paolol@salsan.com>
 *)
...
TYPE
  ...
  TWriteProc = procedure(VAR DTA; NBytes:WORD; VAR Bytes_Put : longWORD) of object;
  ...
  TReadProc = procedure(VAR DTA; NBytes:WORD; VAR Bytes_Got : longWORD) of object;
...
VAR
  tmp,i, p, cmp : Int16;
  key : TBufPtr;
  c : Int16; { 24/03/99 F.Piette, changed WORD to Int16 to make Delphi 4 happy }
BEGIN
  cmp := 1;
  key := @text_buf^[r];
  p := SUCC(N) + key^[0];
...
VAR
  i, j, l : Int16;
  k : WORD; { 24/03/99 F. Piette, changed k from int16 to WORD }
BEGIN
