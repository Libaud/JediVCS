...
uses
  Classes, SysUtils, Windows, CBroker, RFormat, ApsCli, JVCSTypes, VCSCommon, JclFileUtils,
  {$IFNDEF NOFORMS}
    Controls
    {$IFNDEF DELPHI6_UP}
    , Forms
...
type
  ...
  private
    ...
    { TODO -oFL : To be review for typed FFunctionCode with set of }
    // Added by F. Libaud (not present in original source)
  ...
  public
    ...
    {$ENDIF ~NOFORMS}
    function  WaitForAnswer(Timeout: Integer): Boolean; {$ifndef FPC}override;{$endif}
...
begin
  { TODO -oFL : A revoir pour FUserData }
  {case Index of
    0:
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        { Todo -oFL : To be review for RequestDone implementation }
