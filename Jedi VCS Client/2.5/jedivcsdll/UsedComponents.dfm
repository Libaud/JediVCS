object VCSUsedComponents: TVCSUsedComponents
  Left = 328
  Top = 279
  AutoScroll = False
  ...
  object elvperForm: TdfsEnhListView
    Left = 0
    Top = 0
    Width = 313
    Height = 232
  ...
  object elvperProject: TdfsEnhListView
    Left = 316
    Top = 0
    Width = 176
    Height = 232
    ...
    ShowSortArrows = True
    Style = lvOwnerDrawFixed
    OnDrawItem = elvperProjectDrawItem
    Align = alClient
    Columns = <
      item
